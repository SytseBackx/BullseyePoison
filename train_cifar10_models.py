...
def main():
    ...
    def test(epoch):
        ...
        if acc > best_acc:
            ...
            torch.save(state, './checkpoint-ln/clean-cifar10-ckpt-%s-%dto%d-dp%.3f-droplayer%.3f-seed%d-epoch%d.t7' % (args.net,
                                                                                                        args.eidx,
                                                                                                        args.sidx,
                                                                                                        args.train_dp,
                                                                                                        args.droplayer,
        ...
        torch.save(state, './checkpoint-ln/clean-10-ckpt-%s-%dto%d-dp%.3f-droplayer%.3f-seed%d-latest.t7' % (args.net,
                                                                                                            args.eidx,
                                                                                                            args.sidx,
                                                                                                            args.train_dp,
                                                                                                            args.droplayer,
